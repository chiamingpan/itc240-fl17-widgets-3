...
if(isset($_GET['id'])) {//process data // //cast the data to an integer, for security purposes // 
    $id = (int)$_GET['id']; }else{//redirect to safe page 
...
?>
        ...
        {# only admins can see 'peek a boo' link:
            echo '<p align="left"><a href="' . $config->virtual_path . '/upload_form.php?' . $_SERVER['QUERY_STRING'] . '">UPLOAD IMAGE</a></p>';
            /*
